...
// ManhattenDistance calculates the shortest distance
// from the center to the goal in a spiral-scheme world.
func ManhattenDistance(goal int) int {
	...
	return goalManhattenDistance
}

// CalculateRingInformation calculates:
// - currentRingMaxValue
// - currentRingMinValue
// - currentRingNumber
// - currentRingSideSize
func CalculateRingInformation(value int) (currentRingMaxValue, currentRingMinValue, currentRingNumber, currentRingSideSize int) {
	...
	currentRingSideSize = 0

	// Search!
	for currentRingMaxValue < value {
		currentRingNumber++
		currentRingSideSize += 2
		currentRingMinValue = currentRingMaxValue + 1
		currentRingMaxValue += 4 * currentRingSideSize
	}

	return currentRingMaxValue, currentRingMinValue, currentRingNumber, currentRingSideSize
}
